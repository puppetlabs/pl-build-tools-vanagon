...
SET(PL_TOOLS_PREFIX      ${PL_TOOLS_ROOT}/ppc64le-redhat-linux)
SET(PL_TOOLS_SYSROOT     ${PL_TOOLS_PREFIX}/sysroot/lib)
SET(CMAKE_C_COMPILER     ${PL_TOOLS_ROOT}/bin/ppc64le-redhat-linux-gcc)
SET(CMAKE_CXX_COMPILER   ${PL_TOOLS_ROOT}/bin/ppc64le-redhat-linux-g++)
SET(CMAKE_AR             ${PL_TOOLS_PREFIX}/bin/ar CACHE FILEPATH "Archiver")
SET(CMAKE_LINKER         ${PL_TOOLS_ROOT}/bin/ppc64le-redhat-linux-gcc CACHE PATH "Linker Program")
