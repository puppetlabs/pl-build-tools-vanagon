...
SET(PL_TOOLS_PREFIX      ${PL_TOOLS_ROOT}/powerpc64le-suse-linux)
SET(PL_TOOLS_SYSROOT     ${PL_TOOLS_PREFIX}/sysroot/lib)
SET(CMAKE_C_COMPILER     ${PL_TOOLS_ROOT}/bin/powerpc64le-suse-linux-gcc)
SET(CMAKE_CXX_COMPILER   ${PL_TOOLS_ROOT}/bin/powerpc64le-suse-linux-g++)
SET(CMAKE_AR             ${PL_TOOLS_PREFIX}/bin/ar CACHE FILEPATH "Archiver")
SET(CMAKE_LINKER         ${PL_TOOLS_ROOT}/bin/powerpc64le-suse-linux-gcc CACHE PATH "Linker Program")
