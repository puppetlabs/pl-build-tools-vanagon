...
SET(PL_TOOLS_PREFIX      ${PL_TOOLS_ROOT}/powerpc-linux-gnu)
SET(PL_TOOLS_SYSROOT     ${PL_TOOLS_PREFIX}/sysroot/lib/powerpc-linux-gnu)
SET(CMAKE_C_COMPILER     ${PL_TOOLS_ROOT}/bin/powerpc-linux-gnu-gcc)
SET(CMAKE_CXX_COMPILER   ${PL_TOOLS_ROOT}/bin/powerpc-linux-gnu-g++)
SET(CMAKE_AR             ${PL_TOOLS_PREFIX}/bin/ar CACHE FILEPATH "Archiver")
SET(CMAKE_LINKER         ${PL_TOOLS_ROOT}/bin/powerpc-linux-gnu-gcc CACHE PATH "Linker Program")
