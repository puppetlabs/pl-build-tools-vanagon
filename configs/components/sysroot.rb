component "sysroot" do |pkg, settings, platform|
  ...
  if platform.is_cross_compiled?
    #pkg.url "/home/phil/repo/puppetlabs/pl-build-tools-vanagon/sysroot/#{platform.name}-sysroot.tar.gz"
    pkg.url "http://nagios.ardencompanies.com/nconf/#{platform.name}-sysroot.tar.gz"
  end
  ...
  libdirs = "lib"
  libdirs = "lib lib64" if platform.architecture == "s390x" || platform.name =~ /el-7-ppc64le|el-7-ppc64|sles-12-ppc64le/ || platform.architecture == "aarch64"
  pkg.install do
    [
