component "toolchain" do |pkg, settings, platform|
  if platform.is_linux?
    ...
    if platform.name =~ /debian-8-amd64/
      ...
      pkg.add_source "file://files/cmake/huaweios-toolchain.cmake", sum: "60cb70b191fa1a9ddd1ce9b797e5e32b"
      pkg.add_source "file://files/cmake/debian-8-armhf-toolchain.cmake", sum: "5e3b0ebf98296bab806b5c8d6ea33b59"
    elsif platform.name =~ /sles-\d\d-x86_64/
      # Toolchain file for sles running on zLinux, which builds on sles x86_64
      pkg.add_source "file://files/cmake/sles-s390x-toolchain.cmake", sum: "c5f6dc921e0a83e7c5768db9d00413a2"
    end
    ...
    if platform.os_version == "10"
      pkg.add_source "file://files/cmake/solaris-10-i386-toolchain.cmake", sum: "4ea64aac45e2e1a52bbf75b5e95acf2b"
      pkg.add_source "file://files/cmake/solaris-10-sparc-toolchain.cmake", sum: "e5e679389baaeaa2656750c6481312dc"
    elsif platform.os_version == "11"
      pkg.add_source "file://files/cmake/solaris-11-i386-toolchain.cmake", sum: "406e7febf6b83f9102980ae52055c4e2"
      pkg.add_source "file://files/cmake/solaris-11-sparc-toolchain.cmake", sum: "4a16423fda546c4d50006179b9f013e7"
    else
      fail "Need to define a toolchain file for #{platform.name} first"
    end
  else
  ...
  if platform.is_solaris?
    ...
    if platform.name =~ /debian-8-amd64/
      ...
      pkg.install_file "sles-s390x-toolchain.cmake", "#{settings[:basedir]}/s390x-linux-gnu/pl-build-toolchain.cmake"
    end
  end
end
